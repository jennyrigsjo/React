...
export default function ContactList({contacts, updateContact}) {
    ...
    : <Container className="container contact-list">
        ...
        {contacts.map((contact, index) => (<ContactListItem contact={contact} updateContact={updateContact} id={index} key={index}/>))}
      </Container>;
